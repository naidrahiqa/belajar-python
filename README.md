...
```mermaid
graph LR
    A[Module 01-05<br/>Pemula] --> B[Module 06-10<br/>Menengah Awal]
    B --> C[Project 01<br/>Kalkulator]
    C --> D[Module 11-15<br/>Menengah]
    D --> E[Module 16-20<br/>Lanjut]
    E --> F[Module 21-25<br/>Mahir]
```
...
![Progress](https://img.shields.io/badge/Progress-40%25-yellow.svg)
